...
import com.devtwist.medtalk.databinding.ActivityDoctorHomeBinding;
 ...
 */
        ...
        fragmentAdapter = new FragmentAdapter(this, "Doctor");
        ...
        binding.viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                binding.tabLayout.getTabAt(0).setIcon(R.drawable.appointment_icon);
                binding.tabLayout.getTabAt(1).setIcon(R.drawable.messege_icon);
                binding.tabLayout.getTabAt(2).setIcon(R.drawable.user_icon);
                if (position == 0) {
