...
public class CreateStudentProfileActivity extends AppCompatActivity {
    ...
    private String token, uId, username, gender, hospital, education, extraQualification, certifications, category, bio,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCreateStudentProfileBinding.inflate(getLayoutInflater());
        ...
        token = uId = username = gender = hospital = education = extraQualification = certifications = category = bio
                = profileUrl = phoneNo = email = province = city = address = "";
        ...
        binding.province.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (i==1){
                    adapter = ArrayAdapter.createFromResource(CreateStudentProfileActivity.this,
    ...
    private void captureImage() {
        ...
        Dexter.withActivity(CreateStudentProfileActivity.this).withPermission(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new PermissionListener() {
            ...
            public void onPermissionDenied(PermissionDeniedResponse response) {
                Toast.makeText(CreateStudentProfileActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
            }
        ...
        if (requestCode==1 && resultCode == RESULT_OK ) {
            ...
            try {
                CropImage.activity(proPicFilePath)
                        .setAspectRatio(1,1)
                        .start(CreateStudentProfileActivity.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private void checkAttributes() {
        ...
        if (proPicFilePath!=null && username.length()>=3 && !gender.equals("Select Gender") && hospital.length()>0 && bio.length()>1 && !province.equals("Select Province") && !city.equals("Select City") &&
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        FirebaseMessaging.getInstance().getToken().addOnSuccessListener(new OnSuccessListener<String>() {
                            ...
                            public void onSuccess(String s) {
                                ...
                                StudentData studentData = new StudentData(uId, s, username, gender, hospital, bio, education, extraQualification, certifications,
                                        uri.toString(), category, city, address, phoneNo, email, 0.0, 0.0, 0);

                                //upload data to firebase...
                                FirebaseDatabase.getInstance().getReference().child("Users").child(accType).child(uId).setValue(studentData).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
...
//                                        sendNotification.sendNotification();
                                        ...
                                        Intent intent = new Intent(CreateStudentProfileActivity.this, StudentHomeActivity.class);
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        binding.progressBar.setVisibility(View.GONE);
                                        binding.submitProfile.setVisibility(View.VISIBLE);
                                        Toast.makeText(CreateStudentProfileActivity.this, "Check your internet\nconnection", Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        });
