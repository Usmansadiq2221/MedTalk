...
public class AllCategoryAdapter extends RecyclerView.Adapter<AllCategoryAdapter.CategoryViewHolder> {
    ...
    public AllCategoryAdapter(Context mContext, int[] categoryImageList, String[] categoryTextList) {
    ...
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_category_items, parent, false);
    ...
    public class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public CategoryViewHolder(@NonNull View itemView) {
            ...
            _categoryImage = (ImageView) itemView.findViewById(R.id._aCImageItem);
            _categoryTextItem = (TextView) itemView.findViewById(R.id._aCTextItem);
        }
    }
}
